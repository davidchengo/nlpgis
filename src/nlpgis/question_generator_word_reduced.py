with open("question_word.txt", 'w') as fw:
    ...
    line = 'What is the location of Columbus?\n'
    fw.write(line)
    line = 'What are the locations of Columbus and Dayton?\n'
    fw.write(line)
    
    line = 'Where is the location of Columbus?\n'
    fw.write(line)
    line = 'Where are the locations of Columbus and Dayton?\n'
    fw.write(line)
